...
def generations(draw: Any) -> Generation:
    ...
    return Generation(
        ...
        gateway_request_id=_marked("gateway_request_id"),
        synthetic=draw(st.booleans()),
        client_source=_marked("client_source"),
        client_sdk=_marked("client_sdk"),
        client_sdk_version=_marked("client_sdk_version"),
        client_lang=_marked("client_lang"),
        client_runtime=_marked("client_runtime"),
        client_os=_marked("client_os"),
        client_arch=_marked("client_arch"),
        client_timeout_ms=draw(st.one_of(st.none(), st.integers(1, 3_600_000))),
        client_attempt=draw(st.one_of(st.none(), st.integers(0, 99))),
        client_prev_outcome=_marked("client_prev_outcome"),
        client_prev_error_class=_marked("client_prev_error_class"),
        client_prev_host=_marked("client_prev_host"),
        client_prev_elapsed_ms=draw(st.one_of(st.none(), st.integers(0, 3_600_000))),
        client_since_first_ms=draw(st.one_of(st.none(), st.integers(0, 3_600_000))),
        client_stream=draw(st.one_of(st.none(), st.booleans())),
        client_failover_used=draw(st.one_of(st.none(), st.booleans())),
...
def test_benchmark_row_never_carries_free_text(provider: str, model: str, tokens: int) -> None:
