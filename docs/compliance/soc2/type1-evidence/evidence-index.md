...
| E-011 | `docs/compliance/soc2/type1-evidence/incident-log-2026-06-07.md` | Draft | TR-OPS-002, TR-OPS-003 | Includes smoke-test failures as events needing triage and records the resolved legal-route deploy event. |
...
| E-015 | Production HTTP snapshot | Collected | TR-POL-001, TR-PRIV-001 | `/`, `/legal`, `/legal/procurement.json`, `/security`, `/providers`, trust, and status verified 200 on 2026-06-07. |
