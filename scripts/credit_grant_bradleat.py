"""One-shot $20 credit grant for bradleat@inkibra.com (manual top-up).

User (Joseph) asked to add $20 of credit to bradleat@inkibra.com on
...
Usage:
    ...
    PYTHONPATH=src python3 scripts/credit_grant_bradleat.py
"""
...
EVENT_ID = "manual_grant_bradleat_2026-06-26_twenty_dollars"
...
def main() -> int:
    ...
    print(f"granting ${AMOUNT_DOLLARS} ({AMOUNT_MICRODOLLARS} μ$) to workspace {workspace.id} ({workspace.name!r})")
