...
ENV_VARS=(
  ...
  "TR_SES_AUTH_FROM_EMAIL=accounts@auth.trustedrouter.com"
  "TR_SES_AUTH_FROM_NAME=TrustedRouter Accounts"
  "TR_SES_AUTH_CONFIGURATION_SET=trustedrouter-auth"
  "TR_SES_ONBOARDING_FROM_EMAIL=hello@onboarding.trustedrouter.com"
  "TR_SES_ONBOARDING_FROM_NAME=TrustedRouter"
  "TR_SES_ONBOARDING_CONFIGURATION_SET=trustedrouter-onboarding"
  ...
  "TR_SES_SUPPORT_FROM_EMAIL=support@support.trustedrouter.com"
  "TR_SES_SUPPORT_FROM_NAME=TrustedRouter Support"
  "TR_SES_SUPPORT_CONFIGURATION_SET=trustedrouter-support"
  "TR_SES_PARTNER_FROM_EMAIL=partners@partners.trustedrouter.com"
  "TR_SES_PARTNER_FROM_NAME=TrustedRouter Partnerships"
  "TR_SES_PARTNER_CONFIGURATION_SET=trustedrouter-partners"
