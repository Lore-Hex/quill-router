...
echo
echo "and again for synthetic_probe_samples, spend_lease_shadow,"
echo "client_request_events, and client_minute_counters. ingest_version is carried through,"
echo "so re-running it collapses instead of double-counting."
echo
echo "COVERAGE: the drain replicates activity_generations,"
echo "synthetic_probe_samples, spend_lease_shadow, client_request_events, client_minute_counters,"
