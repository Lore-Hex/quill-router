...
gc run jobs "$mutation" "$JOB_NAME" \
  ...
  --args="-m,trusted_router.trust_backfill_cli,--account-id,${ACCOUNT_ID},--environment,production,--history-start,${HISTORY_START},--drain-window-start,${DRAIN_START},--apply" \
