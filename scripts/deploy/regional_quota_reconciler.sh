...
env_vars=(
  ...
  "TR_REGIONAL_QUOTA_LEASE_PILOT_WORKSPACE_IDS=${TR_REGIONAL_QUOTA_LEASE_PILOT_WORKSPACE_IDS}"
  "TR_REGIONAL_QUOTA_LEASE_TTL_SECONDS=${TR_REGIONAL_QUOTA_LEASE_TTL_SECONDS}"
  "TR_REGIONAL_QUOTA_LEASE_MAX_MICRODOLLARS=${TR_REGIONAL_QUOTA_LEASE_MAX_MICRODOLLARS}"
  "TR_REGIONAL_QUOTA_LEASE_MAX_AVAILABLE_BASIS_POINTS=${TR_REGIONAL_QUOTA_LEASE_MAX_AVAILABLE_BASIS_POINTS}"
  "TR_REGIONAL_QUOTA_LEASE_SHARD_COUNT=${TR_REGIONAL_QUOTA_LEASE_SHARD_COUNT}"
  "TR_REGIONAL_QUOTA_BIGTABLE_TABLE=${TR_REGIONAL_QUOTA_BIGTABLE_TABLE}"
  "TR_REGIONAL_QUOTA_BIGTABLE_APP_PROFILES=${TR_REGIONAL_QUOTA_BIGTABLE_APP_PROFILES}"
  "TR_REGIONAL_QUOTA_LEDGER_TIMEOUT_SECONDS=${TR_REGIONAL_QUOTA_LEDGER_TIMEOUT_SECONDS}"
