...
ROUTES = [
    ...
    ('deepseek/deepseek-v4.1-flash', 'DeepSeek V4.1 Flash', 'together'),
    ('openai/gpt-5.5', 'GPT-5.5', 'openai'),
]


def project(endpoints, status, captured_at):
    routes = []
    ...
    return dict(captured_at=captured_at, routes=routes, status=dict(
