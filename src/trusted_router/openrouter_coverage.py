...
ROUTE_COVERAGE: tuple[RouteCoverage, ...] = (
    ...
    RouteCoverage("/images", "POST", "stub", "Image generation is not supported in this release."),
    RouteCoverage("/images/models", "GET", "stub", "Image generation is not supported in this release."),
    RouteCoverage(
        "/images/models/{author}/{slug}/endpoints",
        "GET",
        "stub",
        "Image generation is not supported in this release.",
    ),
