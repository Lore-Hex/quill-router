...
ROUTE_COVERAGE: tuple[RouteCoverage, ...] = (
    ...
    RouteCoverage("/embeddings", "POST", "real", "OpenAI/Gemini/Together/Cohere embeddings via the attested gateway."),
    ...
    RouteCoverage("/guardrails/assignments/members", "GET", "stub", "Guardrails are not supported."),
    ...
    RouteCoverage("/guardrails/{id}/assignments/keys", "GET", "stub", "Guardrails are not supported."),
    RouteCoverage("/guardrails/{id}/assignments/keys", "POST", "stub", "Guardrails are not supported."),
    RouteCoverage("/guardrails/{id}/assignments/keys/remove", "POST", "stub", "Guardrails are not supported."),
    RouteCoverage("/guardrails/{id}/assignments/members", "GET", "stub", "Guardrails are not supported."),
    RouteCoverage("/guardrails/{id}/assignments/members", "POST", "stub", "Guardrails are not supported."),
    RouteCoverage("/guardrails/{id}/assignments/members/remove", "POST", "stub", "Guardrails are not supported."),
    ...
    RouteCoverage("/videos", "POST", "stub", "Video is not supported."),
    RouteCoverage("/videos/models", "GET", "stub", "Video is not supported."),
    RouteCoverage("/videos/{jobId}", "GET", "stub", "Video is not supported."),
    RouteCoverage("/videos/{jobId}/content", "GET", "stub", "Video is not supported."),
