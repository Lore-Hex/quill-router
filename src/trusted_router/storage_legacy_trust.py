...
def create_spanner_legacy_authorization(
    keys: Any, authorization: Any, index_id: str | None,
    *, expected_pause_epoch: int | None = None,
    ...
    def create(tx: Any) -> Any:
        ...
        if billing_paused_tx(tx, io.param_types, authorization.workspace_id) or (
            ...
            if key is not None and key.limit_microdollars is not None and (
                str(authorization.usage_type).lower() != "byok" or key.include_byok_in_limit
            ):
