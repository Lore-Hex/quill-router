...
def _benchmark_from_body(body: Any) -> ProviderBenchmarkSample:
    ...
    kwargs: dict[str, Any] = {
        ...
        "visible_output_tokens": int(body.get("visible_output_tokens") or 0),
        "reasoning_tokens": int(body.get("reasoning_tokens") or 0),
        "requested_output_tokens": int(body.get("requested_output_tokens") or 0),
        "synthetic_slot": _optional_int(body.get("synthetic_slot")),
