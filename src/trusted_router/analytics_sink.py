...
def _row_from_sample(sample: Any) -> dict[str, Any]:
    ...
    row = {
        ...
        "visible_output_tokens": int(raw.get("visible_output_tokens") or 0),
        "reasoning_tokens": int(raw.get("reasoning_tokens") or 0),
        "requested_output_tokens": int(raw.get("requested_output_tokens") or 0),
        "synthetic_slot": _optional_int(raw.get("synthetic_slot")),
