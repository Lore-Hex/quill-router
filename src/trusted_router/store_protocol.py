...
class Store(Protocol):
    ...
    def find_user_by_username(
        ...
        """Read index then user for valid names; never return the miss fallback.

        Transfers must supply a real sender ID to match user-row read work.
        """
        ...
    ...
    def reserve(
        ...
        *,
        ...
        key_reserved_microdollars: int | None = ...,
    ) -> Reservation: ...
    ...
    def observe_receipt_key(
        self, record: ReceiptKey, *, refresh_last_seen: bool = ...
    ) -> str: ...
