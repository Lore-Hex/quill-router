...
BLOG_POSTS: tuple[BlogPost, ...] = (
    BlogPost(
        ...
        description="The most-censored model on FreedomBench is GLM-4.7 served by Z.ai, which goes silent on 27 of 60 plain facts Beijing censors. Run the identical open weights on Cerebras — or Z.ai's own flash endpoint — and all 27 come back answered. The censorship lives in the API endpoint, not the model.",
...
<p>The model already knows the truth. Whether you hear it depends on whose server you asked.</p>
""",
    ),
    BlogPost(
