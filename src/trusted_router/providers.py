...
OPENAI_COMPATIBLE_PROVIDERS: dict[str, tuple[tuple[str, ...], str]] = {
    ...
    # 0G's unrestricted standard router catalog. No private-routing header is
    # sent, so these routes must not carry confidential-compute or E2EE claims.
    "zero-g": (("ZERO_G_ALL_API_KEY",), "https://router-api.0g.ai/v1"),
